...
class UpdateTerminalCategoryRequest extends FormRequest
{
    /**
    ...
    {
        $category = $this->route('terminalCategory');
    ...
    {
        $categoryId = $this->route('terminalCategory')->id;
        ...
        return [
            'category_code' => [
                ...
                'max:50',
                'regex:/^[A-Z0-9]+$/',
                Rule::unique('terminal_categories', 'category_code')->ignore($categoryId),
            ],
            'category_name' => [
                'required',
                'string',
