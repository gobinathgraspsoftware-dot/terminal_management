...
class TerminalModelController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('technician.terminal_models.index', compact('categories'));
    }
    ...
    public function datatable(Request $request): JsonResponse
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('actions', fn($model) => '<a href="' . route('technician.terminal-models.show', $model) . '" class="btn btn-sm btn-outline-primary"><i class="bi bi-eye"></i> View</a>')
