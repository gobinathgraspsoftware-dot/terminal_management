...
class SerialMovementHistoryController extends Controller
{
    ...
    /**
     * Display own serial movements with DataTable and filters.
     */
    public function index(Request $request)
    {
        ...
        return view('technician.serial-movement-history.index', compact('stats', 'filterOptions'));
    }
    ...
    public function show(int $serialId)
    {
        ...
        return view('technician.serial-movement-history.show', $data);
    }
        ...
        return response()->json([
            ...
            'movements' => $movements->map(function ($m) {
                return [
                    ...
                    'is_reversible'   => false, // Technicians cannot reverse
                ];
            }),
