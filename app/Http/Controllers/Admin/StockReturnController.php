...
class StockReturnController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return datatables()->eloquent($query)
                ...
                ->addColumn('action', function ($return) {
                    ...
                    // View
                    $actions .= '<a href="' . route('admin.stock-returns.show', $return->id) . '" 
                    ...
                    if ($return->status === StockIssue::STATUS_DRAFT && auth()->user()->can('edit_stock_returns')) {
                        $actions .= '<a href="' . route('admin.stock-returns.edit', $return->id) . '" 
                    ...
                    // Print
                    $actions .= '<a href="' . route('admin.stock-returns.print', $return->id) . '" 
        ...
        return view('admin.stock-returns.index', compact('depots', 'technicians'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.stock-returns.create', compact('depots', 'technicians', 'models'));
    }
    ...
    public function store(StoreStockReturnRequest $request)
    {
        try {
            ...
            return response()->json([
                ...
                'redirect' => route('admin.stock-returns.show', $stockReturn->id)
            ]);
        } catch (Exception $e) {
            return response()->json([
                'success' => false,
    ...
    public function show(StockIssue $stockReturn)
    {
        ...
        return view('admin.stock-returns.show', compact('stockReturn'));
    }
    ...
    public function edit(StockIssue $stockReturn)
    {
        ...
        if ($stockReturn->status !== StockIssue::STATUS_DRAFT) {
            return redirect()->route('admin.stock-returns.show', $stockReturn->id)
        ...
        return view('admin.stock-returns.edit', compact('stockReturn', 'depots', 'technicians', 'models'));
    }
    ...
    public function print(StockIssue $stockReturn)
    {
        ...
        return view('admin.stock-returns.print', compact('stockReturn'));
    }
