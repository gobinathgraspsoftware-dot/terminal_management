...
use App\Http\Requests\ApproveStockAdjustmentRequest;
        ...
        try {
            ...
            if ($request->ajax()) {
                return response()->json([
                    ...
                    'redirect' => route('admin.stock-adjustments.show', $adjustment->id)
                ]);
            }

            return redirect()
                ->route('admin.stock-adjustments.show', $adjustment->id)
