...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Supervisor 1 - Kuala Lumpur Team
        ...
        $this->command->info('✅ Supervisor created: supervisor.kl@tms.com (KL Team)');

        // Supervisor 2 - Penang Team
        ...
        $this->command->info('✅ Supervisor created: supervisor.penang@tms.com (Penang Team)');

        // Supervisor 3 - Johor Team
        ...
        $this->command->info('✅ Supervisor created: supervisor.johor@tms.com (Johor Team)');
        ...
        $technician1 = User::create([
            ...
            'phone' => '+60123456801',
            'status' => 'active',
            'supervisor_id' => $supervisor1->id, // Reports to KL Supervisor
        ...
        $technician3 = User::create([
            ...
            'phone' => '+60123456803',
            'status' => 'active',
            'supervisor_id' => $supervisor2->id, // Reports to Penang Supervisor
        ...
        $technician5 = User::create([
            ...
            'phone' => '+60123456805',
            'status' => 'active',
            'supervisor_id' => $supervisor3->id, // Reports to Johor Supervisor
        ...
        $this->command->info('   → Supervisors: 3 (KL, Penang, Johor teams)');
        $this->command->info('   → Technicians: 7 (6 with supervisors + 1 independent)');
        $this->command->info('   → Total Users: 12');
        $this->command->info('');
        ...
        $this->command->info('   • supervisor.kl@tms.com / password123 (KL Team)');
        $this->command->info('   • supervisor.penang@tms.com / password123 (Penang Team)');
        $this->command->info('   • supervisor.johor@tms.com / password123 (Johor Team)');
        $this->command->info('');
