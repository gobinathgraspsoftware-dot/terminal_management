...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="{{ route('supervisor.purchase-orders.pdf', $purchaseOrder) }}" class="btn btn-info" target="_blank">
                <i class="bi bi-file-pdf"></i> View PDF
            </a>
            @if(in_array($purchaseOrder->status, ['draft', 'pending_approval']) && $purchaseOrder->created_by === auth()->id())
                <a href="{{ route('supervisor.purchase-orders.edit', $purchaseOrder) }}" class="btn btn-warning">
