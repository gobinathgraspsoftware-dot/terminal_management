...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-body py-3">
            <form method="GET" action="{{ route('supervisor.grn-reports.register') }}" id="filterForm">
                <div class="row g-2">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('supervisor.grn-reports.register') }}" class="btn btn-sm btn-outline-secondary">
                                ...
                                <tr>
                                    @if($index === 0)
                                        <td rowspan="{{ $lineCount ?: 1 }}">
                                            <a href="{{ route('supervisor.grns.show', $grn) }}" class="fw-bold text-decoration-none">
                                                {{ $grn->grn_no }}
                                            </a>
                                        </td>
...
$(document).ready(function() {
    ...
    $('#btnExport').on('click', function() {
        ...
        window.location.href = '{{ route("supervisor.grn-reports.export-register") }}?' + params;
    });
});
</script>
@endpush
