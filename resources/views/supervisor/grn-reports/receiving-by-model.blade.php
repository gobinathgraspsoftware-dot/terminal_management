...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-body py-3">
            <form method="GET" action="{{ route('supervisor.grn-reports.receiving-by-model') }}" id="filterForm">
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-md-2 d-flex gap-2">
                        ...
                        <a href="{{ route('supervisor.grn-reports.receiving-by-model') }}" class="btn btn-sm btn-outline-secondary">
                            Reset
                        </a>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#btnExport').on('click', function() {
        ...
        window.location.href = '{{ route("supervisor.grn-reports.export-receiving-by-model") }}?' + params;
    });
