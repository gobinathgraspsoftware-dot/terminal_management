        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body text-center p-4">
                    ...
                    <a href="{{ route('supervisor.grn-reports.register') }}" class="btn btn-primary">
        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body text-center p-4">
                    ...
                    <a href="{{ route('supervisor.grn-reports.receiving-by-vendor') }}" class="btn btn-success">
                        <i class="bi bi-eye me-1"></i> View Report
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body text-center p-4">
                    ...
                    <a href="{{ route('supervisor.grn-reports.receiving-by-model') }}" class="btn btn-info text-white">
                        <i class="bi bi-eye me-1"></i> View Report
                    </a>
                </div>
            </div>
