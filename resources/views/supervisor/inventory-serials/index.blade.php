...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Team Inventory</h1>
            <p class="text-muted mb-0">View and track your team's serial numbers</p>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card stat-card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-muted mb-1 small">Issued to Team</p>
    ...
    <!-- Filters Card -->
    @include('supervisor.inventory-serials._filters')

    <!-- Data Table Card -->
    <div class="card">
        <div class="card-header bg-white">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Team Serial Numbers</h5>
                <div class="d-flex gap-2">
...
$(document).ready(function() {
        ...
        table = $('#serialsTable').DataTable({
            ...
            ajax: {
                ...
                data: function(d) {
                    ...
                    d.technician_id = $('#filterTechnician').val();
    ...
    $('#btnExport').on('click', function() {
        const params = new URLSearchParams({
            ...
            technician_id: $('#filterTechnician').val() || '',
            warranty_status: $('#filterWarranty').val() || '',
            search: $('#searchInput').val() || ''
        });
        
        window.location.href = '{{ route('supervisor.inventory-serials.export') }}?' + params.toString();
    });
