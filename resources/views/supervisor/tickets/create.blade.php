...
<div class="container-fluid">
    ...
    <form id="ticketForm" method="POST" action="{{ route('supervisor.tickets.store') }}">
        @csrf
        {{-- Supervisor is auto-set server-side --}}
        ...
        <div class="row g-4">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="vendor_ticket_ref_no" class="form-control" placeholder="Optional">
                            </div>
                            <div class="col-md-6">
            ...
            <div class="col-lg-4">
                ...
                <button type="submit" id="btnSubmit" class="btn btn-primary w-100 mb-2"><i class="bi bi-check-lg me-1"></i>Create Ticket</button>
            </div>
        </div>
    </form>
</div>
