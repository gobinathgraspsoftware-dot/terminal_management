        ...
        <div class="card-body">
            <form id="ticketForm">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="job_type_id" id="job_type_id" class="form-select" required>
                            ...
                            <option value="{{ $jt->id }}" {{ $ticket->job_type_id == $jt->id ? 'selected' : '' }}>{{ $jt->name }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                ...
                <div class="mt-4 d-flex gap-2">
                    ...
                    <a href="{{ route('supervisor.tickets.show', $ticket->id) }}" class="btn btn-secondary">
...
$(document).ready(function() {
    ...
    // Technicians are team members only - no cascade needed
