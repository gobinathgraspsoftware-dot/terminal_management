...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ $claim->claim_category === 'ticket' ? route('supervisor.claims.ticket-claims') : route('supervisor.claims.other-claims') }}"
    ...
    <div class="alert alert-info d-flex align-items-center mb-3">
        ...
        <span><strong>Internal Supervisor</strong> — View-only mode. Claims are not applicable for your role.</span>
    </div>
    @endif
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        @endif
                        <div class="col-md-6">
                            <p class="mb-1 text-muted small">Technician</p>
