...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('supervisor.claims.other-claims') }}" class="btn btn-outline-secondary">
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.success) {
                    ...
                    setTimeout(() => window.location.href = '{{ route("supervisor.claims.other-claims") }}', 1500);
                } else {
            ...
            error: function(xhr) {
                if (xhr.status === 422) {
                    ...
                    showToast('error', xhr.responseJSON?.message || 'You do not have permission to perform this action.');
                } else {
