                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3 mt-3">
                        ...
                        <div>
                            ...
                            <a href="{{ route('supervisor.quotations.export') }}" class="btn btn-success btn-sm">
                                <i class="bi bi-file-excel"></i> Export
                            </a>
                            @endcan
                            @can('create_quotations')
                            <a href="{{ route('supervisor.quotations.create') }}" class="btn btn-primary btn-sm">
...
$(document).ready(function() {
    ...
    var table = $('#quotations-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route("supervisor.quotations.index") }}',
            data: function(d) {
    ...
    $(document).on('click', '.delete-btn', function() {
        var id = $(this).data('id');
        var url = '{{ route("supervisor.quotations.destroy", ":id") }}'.replace(':id', id);
    ...
    $(document).on('click', '.submit-approval-btn', function() {
        var id = $(this).data('id');
        var url = '{{ route("supervisor.quotations.submit-approval", ":id") }}'.replace(':id', id);
