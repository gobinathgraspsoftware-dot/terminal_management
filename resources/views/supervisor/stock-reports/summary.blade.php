...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('supervisor.stock-reports.summary') }}" id="filterForm">
                <div class="row g-3">
                    <div class="col-md-3">
...
function exportSummary() {
    ...
    form.action = "{{ route('supervisor.stock-reports.export-summary') }}";
    form.method = "POST";
    ...
    setTimeout(() => {
        form.action = "{{ route('supervisor.stock-reports.summary') }}";
        form.method = "GET";
        csrfInput.remove();
    }, 100);
}
