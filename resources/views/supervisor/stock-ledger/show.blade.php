...
<div class="container-fluid">
    <!-- Back Button -->
    <div class="mb-3">
        <a href="{{ route('supervisor.stock-ledger.index') }}" class="btn btn-secondary">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($stockLedger->reversedByEntry)
                                        <a href="{{ route('supervisor.stock-ledger.show', $stockLedger->reversedByEntry->id) }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($stockLedger->reversalOfEntry)
                                        <a href="{{ route('supervisor.stock-ledger.show', $stockLedger->reversalOfEntry->id) }}">
...
<div class="modal fade" id="reverseModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="reverseForm" action="{{ route('supervisor.stock-ledger.reverse', $stockLedger->id) }}" method="POST">
                @csrf
