...
<div class="container-fluid">
        ...
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('supervisor.stock-returns.show', $stockReturn->id) }}">{{ $stockReturn->issue_no }}</a></li>
    ...
    <form id="returnForm" action="{{ route('supervisor.stock-returns.update', $stockReturn->id) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="col-md-4">
                <div class="card sticky-top" style="top: 20px;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('supervisor.stock-returns.show', $stockReturn->id) }}" class="btn btn-secondary w-100">
