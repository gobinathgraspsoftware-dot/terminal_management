...
<div class="container-fluid">
    ...
    <form id="returnForm" action="{{ route('supervisor.stock-returns.store') }}" method="POST">
        @csrf
            ...
            <div class="col-md-4">
                <div class="card sticky-top" style="top: 20px;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('supervisor.stock-returns.index') }}" class="btn btn-secondary w-100">
...
function loadTechnicianInventory(techId) {
    $.ajax({
        url: "{{ route('supervisor.stock-returns.technician-summary') }}",
...
function loadSerials(row, techId, modelId) {
    ...
    $.ajax({
        url: "{{ route('supervisor.stock-returns.technician-inventory') }}",
