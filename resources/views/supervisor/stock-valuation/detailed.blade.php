...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Inventory value by location and model in your regions</p>
        </div>
        <div>
            <a href="{{ route('supervisor.stock-valuation.index') }}" class="btn btn-outline-secondary me-2">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('supervisor.stock-valuation.detailed') }}" method="GET" id="filterForm">
                <div class="row g-3">
                    <div class="col-md-4">
...
function exportDetailed() {
    ...
    window.location.href = '{{ route("supervisor.stock-valuation.export-detailed") }}?' + params;
}
</script>
@endpush
@endsection
