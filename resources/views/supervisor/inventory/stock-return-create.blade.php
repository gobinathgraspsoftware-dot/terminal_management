...
<div class="container-fluid py-4">
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 small">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('supervisor.inventory.stock-return') }}">Stock Return</a></li>
                    <li class="breadcrumb-item active">New Return</li>
                </ol>
            </nav>
        </div>
        <a href="{{ route('supervisor.inventory.stock-return') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('supervisor.inventory.stock-return.process') }}" method="POST" id="stockReturnForm">
                @csrf
                ...
                <div class="mt-4 pt-3 border-top d-flex gap-2">
                    ...
                    <a href="{{ route('supervisor.inventory.stock-return') }}"
