...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('supervisor.stock-transfers.create') }}" class="btn btn-primary">
...
$(document).ready(function() {
    const table = $('#transfersTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route("supervisor.stock-transfers.index") }}',
            data: function(d) {
    ...
    $('#btnExport').click(function() {
        ...
        window.location.href = '{{ route("supervisor.stock-transfers.export") }}?' + params.toString();
    });
});
</script>
@endpush
