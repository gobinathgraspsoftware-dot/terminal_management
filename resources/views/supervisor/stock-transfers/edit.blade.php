...
<div class="container-fluid">
    ...
    <form id="transferForm" method="POST" action="{{ route('supervisor.stock-transfers.update', $stockTransfer) }}">
        @csrf
        @method('PUT')
...
$(document).ready(function() {
    ...
    $('#fromDepot').change(function() {
        ...
        if (depotId) {
            $.get('{{ route("supervisor.stock-transfers.available-stock") }}', { from_depot_id: depotId })
