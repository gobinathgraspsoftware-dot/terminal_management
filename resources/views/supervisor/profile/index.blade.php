...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('supervisor.profile.edit') }}" class="btn btn-primary">
            ...
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('supervisor.profile.avatar') }}" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-camera"></i> Change Avatar
                        </a>
                        <a href="{{ route('supervisor.profile.password') }}" class="btn btn-outline-secondary btn-sm">
...
$(document).ready(function() {
    ...
    function loadLoginHistory(limit) {
        $.ajax({
            url: '{{ route("supervisor.profile.login-history") }}',
            method: 'GET',
            data: { limit: limit },
