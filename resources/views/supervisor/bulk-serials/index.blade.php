        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 shadow-sm hover-shadow">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('supervisor.bulk-serials.import-form') }}" class="btn btn-primary">
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 shadow-sm hover-shadow">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('supervisor.inventory-serials.index') }}?bulk_action=update" class="btn btn-success">
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 shadow-sm hover-shadow">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('supervisor.inventory-serials.index') }}?bulk_action=transfer" class="btn btn-warning">
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 shadow-sm hover-shadow">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('supervisor.inventory-serials.index') }}?bulk_action=labels" class="btn btn-info">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <a href="{{ route('supervisor.bulk-serials.download-template') }}" class="btn btn-outline-primary btn-block mb-2">
                                <i class="bi bi-download"></i> Download Import Template
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="{{ route('supervisor.inventory-serials.export') }}" class="btn btn-outline-success btn-block mb-2">
                                <i class="bi bi-file-earmark-excel"></i> Export All Serials
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="{{ route('supervisor.inventory-serials.index') }}" class="btn btn-outline-secondary btn-block mb-2">
