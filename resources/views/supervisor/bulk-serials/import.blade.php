            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('supervisor.bulk-serials.index') }}">Bulk Operations</a></li>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="step-content" id="step-1">
                        ...
                        <a href="{{ route('supervisor.bulk-serials.download-template') }}" class="btn btn-primary btn-lg">
                    ...
                    <div class="step-content d-none" id="step-4">
                        ...
                        <div class="mt-3">
                            ...
                            <a href="{{ route('supervisor.inventory-serials.index') }}" class="btn btn-primary">
...
function uploadFile() {
    ...
    $.ajax({
        url: '{{ route("supervisor.bulk-serials.import") }}',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
