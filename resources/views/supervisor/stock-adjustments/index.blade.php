...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="{{ route('supervisor.stock-adjustments.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-circle me-1"></i> New Adjustment
            </a>
            @endcan
            <a href="{{ route('supervisor.stock-adjustments.variance-report') }}" class="btn btn-info">
...
$(document).ready(function() {
    ...
    let table = $('#adjustmentsTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('supervisor.stock-adjustments.index') }}",
            data: function(d) {
    ...
    $('#exportBtn').click(function() {
        ...
        window.location.href = "{{ route('supervisor.stock-adjustments.export') }}?" + params.toString();
    });
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ url('supervisor/stock-adjustments') }}/" + id,
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
