...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            @can('print', $grn)
            <div class="btn-group">
                <a href="{{ route('supervisor.grns.pdf', $grn) }}" class="btn btn-secondary" target="_blank" title="View PDF in Browser">
                    <i class="bi bi-printer me-1"></i> Print PDF
                </a>
                <a href="{{ route('supervisor.grns.download', $grn) }}" class="btn btn-outline-secondary" title="Download PDF">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('supervisor.grns.pdf', $grn) }}" class="btn btn-outline-secondary" target="_blank">
                            <i class="bi bi-printer me-1"></i> View PDF in Browser
                        </a>
                        <a href="{{ route('supervisor.grns.download', $grn) }}" class="btn btn-outline-primary">
    ...
    $('#btn-post').on('click', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '{{ route("supervisor.grns.post", $grn) }}',
                    type: 'POST',
