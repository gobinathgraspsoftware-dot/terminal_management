...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('admin.purchase-orders.export') }}" class="btn btn-success">
...
$(document).ready(function() {
    ...
    // Filter on Enter key
    $('#status-filter, #vendor-filter, #date-from, #date-to').on('keypress', function(e) {
        if (e.which === 13) {
            table.ajax.reload();
        }
    });

    // Auto-reload when status dropdown changes
