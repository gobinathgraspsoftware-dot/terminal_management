...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.stock-valuation.index') }}" method="GET" id="filterForm">
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('admin.stock-valuation.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
                    <a href="{{ route('admin.stock-valuation.detailed') }}" class="btn btn-outline-primary w-100">
                        <i class="bi bi-list-ul"></i> Detailed Valuation by Location
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="{{ route('admin.stock-valuation.movement-value') }}" class="btn btn-outline-success w-100">
                        <i class="bi bi-arrow-left-right"></i> Movement Value Tracking
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="{{ route('admin.stock-balance.index') }}" class="btn btn-outline-info w-100">
...
function exportSummary() {
    ...
    window.location.href = '{{ route("admin.stock-valuation.export-summary") }}?' + params;
}
</script>
@endpush
@endsection
