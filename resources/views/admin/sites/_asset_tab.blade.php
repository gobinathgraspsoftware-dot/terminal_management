        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-end">
                @if($asset->installation_job_id)
                    <a href="{{ route('admin.jobs.show', $asset->installation_job_id) }}" 
                       class="btn btn-sm btn-outline-primary d-block mb-1">
                        <i class="bi bi-clipboard-check me-1"></i> View Installation Job
                    </a>
                @endif
                
                @can('view_assets')
                <button class="btn btn-sm btn-outline-info d-block" onclick="viewAssetDetails({{ $asset->id }})">
...
function viewAssetDetails(assetId) {
    // This would typically open a modal or navigate to asset details page
