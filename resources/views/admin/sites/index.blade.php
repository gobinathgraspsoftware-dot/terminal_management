    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="{{ route('admin.sites.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-circle me-1"></i> New Site
            </a>
            @endcan
        </div>
    </div>
        ...
        <div class="card-header bg-white border-bottom">
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <div>
                        <button type="button" id="btn-reset-filters" class="btn btn-sm btn-secondary w-100">
...
$(document).ready(function() {
    ...
    const table = $('#sites-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route("admin.sites.datatable") }}',
            data: function(d) {
    ...
    $('#btn-reset-filters').on('click', function() {
        $('#filter-client, #filter-state, #filter-status').val('').trigger('change');
        table.draw();
    });
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        if (confirm('Are you sure you want to delete this site?')) {
            $.ajax({
                ...
                error: function(xhr) {
                    alert('Error: ' + (xhr.responseJSON?.message || 'Failed to delete site'));
                }
            });
        }
    });
