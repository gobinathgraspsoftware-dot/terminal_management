...
$(document).ready(function() {
    reportTable = $('#reportTable').DataTable({
        ...
        ajax: { url: '{{ route("admin.reports.claim.data") }}', type: 'GET', data: function(d) { return $.extend(d, getReportFilters()); } },
        columns: [
    ...
    $('#btnExportExcel').on('click', function() { window.location.href = '{{ route("admin.reports.claim.export") }}?' + $.param(getReportFilters()) + '&format=xlsx'; });
    $('#btnExportPdf').on('click', function() { window.location.href = '{{ route("admin.reports.claim.export") }}?' + $.param(getReportFilters()) + '&format=pdf'; });
