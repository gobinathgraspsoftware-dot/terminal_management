...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-body py-3">
            <form method="GET" action="{{ route('admin.grn-reports.receiving-by-vendor') }}" id="filterForm">
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-md-2 d-flex gap-2">
                        ...
                        <a href="{{ route('admin.grn-reports.receiving-by-vendor') }}" class="btn btn-sm btn-outline-secondary">
                            Reset
                        </a>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#btnExport').on('click', function() {
        ...
        window.location.href = '{{ route("admin.grn-reports.export-receiving-by-vendor") }}?' + params;
    });
