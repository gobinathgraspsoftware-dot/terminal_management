        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="client_code" value="{{ $nextCode }}" readonly>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="registration_no" placeholder="e.g., 123456-X">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Tax ID / SST Number</label>
                                <input type="text" class="form-control" name="tax_id" placeholder="e.g., A01-1234-56789012">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="billing_address" rows="2" placeholder="Street address"></textarea>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="billing_postcode" maxlength="5" pattern="[0-9]{5}" placeholder="e.g., 50000">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Country</label>
                                <input type="text" class="form-control" name="billing_country" value="Malaysia" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="pic_phone" placeholder="e.g., 03-12345678">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <textarea class="form-control" name="notes" rows="4" placeholder="Any additional notes or comments"></textarea>
                    </div>
                </div>
