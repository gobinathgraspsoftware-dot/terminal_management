...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">Edit Vendor Type</h1>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white">
            <h5 class="card-title mb-0"><i class="bi bi-tags me-2"></i>Edit: {{ $vendorType->title }}</h5>
        </div>
        <div class="card-body">
            <form id="vendorTypeForm" method="POST" action="{{ route('admin.vendor-types.update', $vendorType) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mt-4 d-flex gap-2">
                    <button type="submit" class="btn btn-primary" id="btnSubmit">
                        <i class="bi bi-check-lg me-1"></i> Update Vendor Type
                    </button>
...
$(function() {
    $('#vendorTypeForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                btn.prop('disabled', false).html('<i class="bi bi-check-lg me-1"></i> Update Vendor Type');
