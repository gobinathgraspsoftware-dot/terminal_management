...
@section('title', 'Stock Out — Inventory')
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1 fw-bold">
                <i class="bi bi-box-arrow-up-right text-danger me-2"></i>Stock Out
            </h4>
    ...
    <div class="alert alert-info d-flex align-items-center mb-4" role="alert">
        ...
        <div>
            Stock Out records are <strong>automatically created</strong> when an installation ticket
            is processed. No manual stock-out entry is required.
        </div>
    </div>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
            <span class="fw-semibold">
                <i class="bi bi-table me-2 text-danger"></i>Stock Out Records
            </span>
            <span class="badge bg-danger" id="totalBadge">0 records</span>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <table id="stockOutTable" class="table table-hover table-striped align-middle mb-0" style="width:100%">
...
$(function () {
    ...
    // ── Chevron toggle ────────────────────────────────────────────────────
    $('#filterPanel').on('show.bs.collapse hide.bs.collapse', function (e) {
        $('#filterChevron').toggleClass('bi-chevron-down bi-chevron-up');
    });

    // ── Show/hide Accessory Type based on Item Type ───────────────────────
    ...
    var table = $('#stockOutTable').DataTable({
        ...
        columns: [
            ...
            { data: 'router_ids',   name: 'router_ids',    searchable: false, orderable: false },
            {
                ...
                render: function (val) {
                    ...
                    return '<span class="badge bg-danger">' + abs + '</span>';
                }
            },
            ...
            { data: 'stockout_date', name: 'stockout_date', searchable: false, orderable: false },
        ...
        language: {
            ...
            emptyTable: '<div class="text-center py-3 text-muted"><i class="bi bi-inbox fs-2 d-block mb-2"></i>No stock-out records found.</div>',
