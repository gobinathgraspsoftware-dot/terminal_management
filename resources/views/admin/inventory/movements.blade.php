...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.inventory.movements.export') }}" class="btn btn-outline-success btn-sm" id="btn-export">
...
$(function() {
    ...
    $('#btn-export').on('click', function(e) {
        e.preventDefault();
        var params = $.param({
            movement_type: $('#filter-type').val(),
            inventory_item_id: $('#filter-item').val(),
