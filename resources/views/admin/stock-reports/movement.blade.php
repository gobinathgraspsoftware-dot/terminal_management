...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('admin.stock-reports.movement-export', request()->query()) }}" class="btn btn-success">
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.stock-reports.movement') }}" id="filterForm">
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('admin.stock-reports.movement') }}" class="btn btn-secondary">
