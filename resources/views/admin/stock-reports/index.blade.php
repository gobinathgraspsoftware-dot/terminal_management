                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('admin.stock-reports.movement') }}" class="btn btn-outline-primary w-100 py-3">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('admin.stock-reports.stock-card') }}" class="btn btn-outline-info w-100 py-3">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('admin.stock-reports.summary') }}" class="btn btn-outline-success w-100 py-3">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('admin.stock-balance.index') }}" class="btn btn-outline-warning w-100 py-3">
