        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    if (typeof toastr !== 'undefined') {
                        ...
                        alert(response.message || 'Vendor updated successfully');
                    }
                    ...
                    if (typeof toastr !== 'undefined') {
                        ...
                        alert(response.message || 'Failed to update vendor');
                    }
            ...
            error: function(xhr) {
                ...
                if (xhr.status === 422) {
                    ...
                    // Other errors
                    errorMessage = xhr.responseJSON?.message || 'Failed to update vendor. Please try again.';
                    if (typeof toastr !== 'undefined') {
