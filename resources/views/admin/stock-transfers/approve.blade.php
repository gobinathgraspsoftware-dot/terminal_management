...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="approvalForm" method="POST" action="{{ route('admin.stock-transfers.approve', $stockTransfer) }}">
                @csrf
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('admin.stock-transfers.show', $stockTransfer) }}" class="btn btn-secondary me-2">
