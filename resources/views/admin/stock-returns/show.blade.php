...
<div class="container-fluid">
    <div class="row mb-3">
        ...
        <div class="col-auto">
            ...
            <a href="{{ route('admin.stock-returns.edit', $stockReturn->id) }}" class="btn btn-warning">
            ...
            <a href="{{ route('admin.stock-returns.print', $stockReturn->id) }}" target="_blank" class="btn btn-secondary">
...
function postReturn() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ route('admin.stock-returns.post', $stockReturn->id) }}",
                method: 'POST',
...
function cancelReturn() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ route('admin.stock-returns.cancel', $stockReturn->id) }}",
                method: 'POST',
                data: {_token: '{{ csrf_token() }}'},
                success: function(response) {
