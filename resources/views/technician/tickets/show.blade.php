    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('technician.tickets.index') }}">Tickets</a></li>
                <li class="breadcrumb-item active">{{ $ticket->ticket_no }}</li>
            </ol>
        </nav>
        <div class="d-flex gap-2">
            <a href="{{ route('technician.tickets.index') }}" class="btn btn-sm btn-outline-secondary">
...
$(document).ready(function() {
    ...
    $('#commentForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route("technician.tickets.comment", $ticket->id) }}',
            method: 'POST',
