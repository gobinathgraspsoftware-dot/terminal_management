            ...
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('technician.profile.avatar') }}" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-camera"></i> Change Avatar
                        </a>
                        <a href="{{ route('technician.profile.password') }}" class="btn btn-outline-secondary btn-sm">
