...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('technician.grns.index') }}">GRNs</a></li>
        ...
        <div>
            @can('update', $grn)
                @if($grn->status === 'draft')
                <a href="{{ route('technician.grns.edit', $grn) }}" class="btn btn-warning">
                </a>
                @endif
            @endcan
            @can('post', $grn)
                ...
                @endif
            @endcan
            <a href="{{ route('technician.grns.index') }}" class="btn btn-outline-secondary">
    ...
    $('#postBtn').on('click', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("technician.grns.post", $grn) }}',
                    method: 'POST',
