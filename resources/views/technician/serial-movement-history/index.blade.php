...
@section('title', 'My Stock Movement History - TMS')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1"><i class="bi bi-clock-history me-2"></i>My Stock Movement History</h4>
...
$(document).ready(function() {
    var table = $('#movementTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route("technician.serial-movement-history.datatable") }}',
            data: function(d) {
