...
<div class="page-header">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            <h1><i class="bi bi-clock-history me-2 text-success"></i>My Payment History</h1>
...
$(function () {
    var table = $('#paymentHistoryTable').DataTable({
        ...
        ajax: {
            url: '{{ route("technician.claims.payment-history-data") }}',
        ...
        columns: [
            ...
            { data: 'paid_at' }, { data: 'status', orderable: false },
