...
<div class="page-header">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            <h1><i class="bi bi-file-earmark-text me-2 text-secondary"></i>My Other Claims</h1>
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        <span><i class="bi bi-table me-2"></i>Other Claims</span>
...
$(function () {
    var table = $('#otherClaimsTable').DataTable({
        ...
        columns: [
            { data: 'claim_no' }, { data: 'claim_type', orderable: false },
            { data: 'description', orderable: false },
            { data: 'total_amount', className: 'text-end' },
            { data: 'status', orderable: false }, { data: 'submitted_at' },
