...
<div class="page-header">
    <div class="d-flex align-items-center justify-content-between">
        <div>
            <h1><i class="bi bi-plus-circle me-2 text-primary"></i>Submit New Claim</h1>
        ...
        <a href="{{ route('technician.claims.other-claims') }}" class="btn btn-outline-secondary btn-sm">
                ...
                <form id="createClaimForm" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" class="form-control" rows="3" placeholder="Describe this claim in detail..." required></textarea>
                        </div>
                        <div class="col-12">
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.success) {
                    ...
                    setTimeout(function(){ window.location = '{{ route("technician.claims.other-claims") }}'; }, 1500);
                } else {
                    showToast(res.message, 'error');
                    btn.prop('disabled', false).html('<i class="bi bi-send me-1"></i>Submit Claim');
                }
            },
            error: function(){ showToast('An error occurred.', 'error'); btn.prop('disabled', false).html('<i class="bi bi-send me-1"></i>Submit Claim'); }
        });
    });
});
</script>
