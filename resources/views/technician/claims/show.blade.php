        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body text-center">
                    ...
                    <hr>
                    <small class="text-muted d-block">Verified {{ $claim->verified_at->format('d/m/Y H:i') }}</small>
                    @endif
                    @if($claim->paid_at)
                    <hr>
                    <small class="text-success d-block fw-semibold">Paid {{ $claim->paid_at->format('d/m/Y H:i') }}</small>
                    @endif
                </div>
            </div>
        </div>
