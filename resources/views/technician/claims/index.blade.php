...
<div class="page-header">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            <h1><i class="bi bi-receipt-cutoff me-2 text-primary"></i>My Claims</h1>
...
<div class="row g-4">
    <div class="col-md-4">
        <a href="{{ route('technician.claims.ticket-claims') }}" class="text-decoration-none">
            <div class="card border-0 shadow-sm hover-lift">
                <div class="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0 small">Auto-created from your tickets</p>
                    </div>
    ...
    <div class="col-md-4">
        <a href="{{ route('technician.claims.other-claims') }}" class="text-decoration-none">
            <div class="card border-0 shadow-sm hover-lift">
                <div class="card-body d-flex align-items-center p-4">
    ...
    <div class="col-md-4">
        <a href="{{ route('technician.claims.payment-history') }}" class="text-decoration-none">
            <div class="card border-0 shadow-sm hover-lift">
                <div class="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0 small">View all your paid claims</p>
                    </div>
                    <i class="bi bi-chevron-right ms-auto text-muted"></i>
                </div>
            </div>
