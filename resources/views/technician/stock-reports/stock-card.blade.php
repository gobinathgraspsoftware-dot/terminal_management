...
<div class="container-fluid">
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('technician.stock-reports.index') }}">My Inventory</a></li>
    ...
    <div class="row mb-3">
        <div class="col-12 text-end">
            <a href="{{ route('technician.stock-reports.export-stock-card', $stockCardData['serial']->id) }}" class="btn btn-success">
                <i class="bi bi-file-earmark-excel me-2"></i>Export to Excel
            </a>
            <a href="{{ route('technician.stock-reports.print-stock-card', $stockCardData['serial']->id) }}" target="_blank" class="btn btn-secondary">
