...
<div class="container-fluid">
        ...
        <div class="col-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('technician.stock-reports.index') }}">Stock Reports</a></li>
    ...
    <div class="row mb-3">
        <div class="col-12 text-end">
            <a href="{{ route('technician.stock-reports.stock-card-export', $stockCardData['serial']->id) }}" class="btn btn-success">
                <i class="bi bi-file-earmark-excel me-2"></i>Export to Excel
            </a>
            <a href="{{ route('technician.stock-reports.stock-card-print', $stockCardData['serial']->id) }}" target="_blank" class="btn btn-secondary">
...
$(document).ready(function() {
    $('#serialSelect').select2({
        ...
        allowClear: true,
        ajax: {
            url: '{{ route("technician.stock-reports.search-serials") }}',
            dataType: 'json',
            delay: 250,
...
function viewStockCard() {
    ...
    if (serialId) {
        window.location.href = '{{ route("technician.stock-reports.stock-card") }}/' + serialId;
    } else {
