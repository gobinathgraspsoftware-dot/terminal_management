...
<div class="container-fluid">
    <div class="row mb-3">
        ...
        <div class="col-auto">
            ...
            <a href="{{ route('technician.stock-returns.edit', $stockReturn->id) }}" class="btn btn-warning">
            ...
            <a href="{{ route('technician.stock-returns.print', $stockReturn->id) }}" target="_blank" class="btn btn-secondary">
...
function postReturn() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ route('technician.stock-returns.post', $stockReturn->id) }}",
                method: 'POST',
...
function cancelReturn() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ route('technician.stock-returns.cancel', $stockReturn->id) }}",
                method: 'POST',
                data: {_token: '{{ csrf_token() }}'},
                success: function(response) {
