...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('technician.stock-returns.index') }}">My Returns</a></li>
    ...
    <!-- My Current Inventory Summary -->
    <div class="card mb-3 bg-light">
        <div class="card-header">
            <h5 class="card-title mb-0"><i class="bi bi-box-seam me-2"></i>My Current Inventory</h5>
        </div>
        <div class="card-body">
            @if($myInventory && $myInventory->count() > 0)
                ...
                <table class="table table-sm table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @php
                                    $badgeClass = $item->status === 'issued' ? 'bg-primary' : 
            ...
            <div class="alert alert-info mb-0">
                <i class="bi bi-info-circle me-2"></i>You currently have no items in your inventory.
            </div>
            @endif
        </div>
    </div>

    <form id="returnForm" action="{{ route('technician.stock-returns.store') }}" method="POST">
        @csrf
        
        <!-- Technician is auto-filled with current user -->
        <input type="hidden" name="from_technician_id" value="{{ auth()->id() }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="remarks" rows="2" 
                                          placeholder="Optional: Add any notes about this return"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card sticky-top" style="top: 20px;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('technician.stock-returns.index') }}" class="btn btn-secondary w-100">
...
function addLine() {
    ...
    $(`tr[data-index="${lineIndex}"] .model-select`).on('change', function() {
        loadMySerials($(this).closest('tr'), $(this).val());
    });
...
function loadMySerials(row, modelId) {
    if (!modelId) return;
    
    $.ajax({
        url: "{{ route('technician.stock-returns.my-inventory') }}",
