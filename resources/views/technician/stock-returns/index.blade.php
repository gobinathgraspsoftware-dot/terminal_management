...
<div class="container-fluid">
    <div class="row mb-3">
        ...
        <div class="col-auto">
            ...
            <a href="{{ route('technician.stock-returns.create') }}" class="btn btn-primary">
...
$(document).ready(function() {
    const table = $('#returnsTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('technician.stock-returns.index') }}",
            data: function(d) {
...
function exportReturns() {
    ...
    let url = "{{ route('technician.stock-returns.export') }}?";
